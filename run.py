...
def serve_react(path=''):
    if path != '' and os.path.exists(os.path.join('frontend', 'react-frontend', 'dist', path)):
        return send_from_directory(os.path.join('frontend', 'react-frontend', 'dist'), path)
    else:
        return send_from_directory(os.path.join('frontend', 'react-frontend', 'dist'), 'index.html')
